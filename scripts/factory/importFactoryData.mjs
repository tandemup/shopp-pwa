...
const result = await client.mutation(api.factory.importFactoryData, {
  stores,
  items,
  scanHistory,
});
...
// CONVEX_URL="https://tu-deployment.convex.cloud" node scripts/factory/importFactoryData.mjs
